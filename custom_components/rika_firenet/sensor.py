...
SENSOR_ATTRIBUTES = {
    ...
    "pellets before service": {
        ...
        "icon": "mdi:weight-kilogram",
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_pellets_before_service",
    ...
    "airflaps": {
        ...
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_outputAirFlaps",
        "state_class": SensorStateClass.MEASUREMENT,
    },
    "number fail": {
        "icon": "mdi:information-outline",
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_number_fail",
    },
    "main state": {
        "icon": "mdi:information-outline",
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_main_state",
    },
    "sub state": {
        "icon": "mdi:information-outline",
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_sub_state",
    },
    "statusError": {
        "icon": "mdi:information-outline",
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_status_error",
    },
    "statusWarning": {
        "icon": "mdi:alert-outline",
        "category": EntityCategory.DIAGNOSTIC,
        "command": "get_status_warning",
    },
    "statusSubError": {
        "icon": "mdi:information-outline",
        "category": EntityCategory.DIAGNOSTIC,
